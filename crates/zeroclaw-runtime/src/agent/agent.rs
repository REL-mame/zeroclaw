...
impl Agent {
    ...
    pub async fn turn(&mut self, user_message: &str) -> Result<String> {
        ...
        let turn_loop = zeroclaw_api::TOOL_SPECS_OVERRIDE
            .scope(
                tool_specs_override,
...
mod tests {
    ...
    fn tool_specs_override_and_disabled_flip() {
        ...
        let spec = crate::tools::ToolSpec::new("alpha", "Alpha", serde_json::json!({"type": "object"}));
    ...
    fn get_configured_tool_specs_mirrors_registry_specs() {
        ...
        assert_eq!(specs[0].parameters.as_ref(), &serde_json::json!({"type": "object"}));
    }
